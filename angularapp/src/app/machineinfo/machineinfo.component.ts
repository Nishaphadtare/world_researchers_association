...
@Component({
  selector: 'app-machineinfo',
  templateUrl: './machineinfo.component.html',
  styleUrls: ['./machineinfo.component.css']
})
  ...
  machineInfoForm : FormGroup;
   ...
   createMachineForm(){
    this.machineInfoForm = new FormGroup({
     ...
     machineno : new FormControl('', Validators.compose([Validators.required])),
    ...
    thaxis : new FormControl('', Validators.compose([Validators.required])),
   ...
   this.editId = type;
     ...
     this.machineInfoForm.setValue({
      ...
      machineno: this.typeArr[index].machineno,
      ...
      length : this.typeArr[index].length,
       ...
       thaxis: this.typeArr[index].thaxis,
